...
- ( NSMutableDictionary *)sendPay
{
     ...
     NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
      NSString *out_trade_no = [userDefaults stringForKey:@"out_trade_no"];
      NSString *url = [userDefaults stringForKey:@"url"];
      NSString *bodtxt = [userDefaults stringForKey:@"bodtxt"];
      NSString *total_fee = [userDefaults stringForKey:@"total_fee"];
    
    //订单标题，展示给用户
    NSString *order_name    = bodtxt;
    //订单金额,单位（分）
    NSString *order_price   = total_fee;//1分钱测试
